...
Feature: clerk and Role management
  ...
  #@ignore
  Scenario Outline: 5.<Clerk ID>: Create new clerks
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 6: Verify correct clerks list sorting
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 7: Verify correct clerks list roles
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 9: Admins can change other clerks' account details.
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 10: Prevent creating a new clerk with an existing Clerk ID
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 11: Rename other clerk's Clerk ID.
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 12: Change other clerk's password.
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 13: Filter the clerks list as Manager.
  ...
  #@ignore
  Scenario: 14: Filter the clerks list as Employee.
  ...
  #@ignore
  Scenario: 15: Change a clerk's role from Eusebia to Manager.
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 16: Change a clerk's role from Manager to Admin.
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 17: Change a clerk's role from Admin to Employee.
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
  ...
  #@ignore
  Scenario: 18: clerk deletion regret.
    Given Aureliano, with ID 1 and Password 111111, is managing clerks,
