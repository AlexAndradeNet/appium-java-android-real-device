...
public class SettingsTransactionFlowOpenTask implements Task {

    @Override
    @Step("{0} opens the Settings > Transaction Options > Transaction Flow screen")
    ...
    public static SettingsTransactionFlowOpenTask now() {
        return new SettingsTransactionFlowOpenTask();
    }
}
